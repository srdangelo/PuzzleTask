...
["_interceptors", "dart:_interceptors", , J, {
  ...
  Interceptor: {
    ...
    "%": "Animation|AnimationNode|ArrayBuffer|Blob|CanvasGradient|CanvasPattern|DOMError|File|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString|WebGLRenderingContext"
  },
  JSBool: {
    "^": "Interceptor;",
    toString$0: function(receiver) {
...
["dart.core", "dart:core", , P, {
  ...
  num__returnNull: [function(_) {
    return;
  }, "call$1", "num__returnNull$closure", 2, 0, 7],
...
["dart.dom.html", "dart:html", , W, {
  ...
  CanvasRenderingContext2D: {
    "^": "Interceptor;fillStyle},font},textAlign},textBaseline}",
...
["remotepuzzletask", "remotepuzzletask.dart", , X, {
  "^": "",
  initWebSocket: function(retrySeconds) {
    ...
    t2 = W.WebSocket_WebSocket("ws://169.254.251.137:4040/ws", null);
    $.ws = t2;
  ...
  main: [function() {
    ...
    t4.enabled = true;
    t4 = new X.Game(null, t1, null, null, null, null, null, new X.TouchManager(false, null, t2, t3), t4, null, "false", "false", "false", "false", null, null, new P.DateTime(Date.now(), false), new P.DateTime(Date.now(), false), true, false, H.setRuntimeTypeInfo([], [X.Touchable]), P.LinkedHashMap_LinkedHashMap(null, null, null, P.$int, X.Touchable), null);
    t4.enabled = true;
    t4.Game$0();
    $.game = t4;
  ...
  Box: {
    ...
    touchDown$1: function(e) {
      this.dragged = true;
      this.touched_x_offset = J.$sub$n(this.x, e.touchX);
      this.touched_y_offset = J.$sub$n(this.y, e.touchY);
    ...
    Box$4: function(id, x, y, color) {
      ...
      t1 = this.img;
      t2 = J.getInterceptor$x(t1);
      t2.set$src(t1, "images/" + H.S(this.color) + ".png");
      this.imageWidth = t2.get$width(t1);
      this.imageHeight = t2.get$height(t1);
    }
  },
  Game: {
    "^": "TouchLayer;canvas,img,ctx,width,height,myState,box,tmanager,tlayer,score,phaseBreak,phaseCongrats,phaseStarted,phaseEnd,clientID,trialNum,time,time_started,flagDraw,submittedID,touchables,touch_bindings,enabled",
    ...
    draw$0: function() {
      if (this.flagDraw)
        if (J.$eq(this.phaseStarted, "false")) {
          ...
          J.fillText$3$x(this.ctx, "Gaze Experimentt: Client# " + H.S(this.clientID) + " Trial# " + H.S(this.trialNum), 100, 50);
          J.fillText$3$x(this.ctx, "Congratuations! You have finished the experiment :)", 100, 150);
        } else {
          this.clear$0(0);
          if (J.$eq(this.phaseBreak, "false"))
            if (J.$eq(this.phaseCongrats, "true")) {
              J.set$fillStyle$x(this.ctx, "black");
              J.set$font$x(this.ctx, "30px sans-serif");
              J.set$textAlign$x(this.ctx, "left");
              J.set$textBaseline$x(this.ctx, "center");
              J.fillText$3$x(this.ctx, "Gaze Experiment: Client# " + H.S(this.clientID) + " Trial# " + H.S(this.trialNum), 100, 50);
              J.fillText$3$x(this.ctx, "Score: " + H.S(this.score), 100, 100);
              J.fillText$3$x(this.ctx, "Congratuations! You have passed this trial.", 100, 150);
              for (var t1 = this.myState.myBoxes, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();)
                t1._current.draw$1(this.ctx);
              this.flagDraw = false;
            } else {
              this.time = new P.DateTime(Date.now(), false);
              J.set$fillStyle$x(this.ctx, "black");
              J.set$font$x(this.ctx, "30px sans-serif");
              J.set$textAlign$x(this.ctx, "left");
              J.set$textBaseline$x(this.ctx, "center");
              J.fillText$3$x(this.ctx, "Gaze Experiment: Client# " + H.S(this.clientID) + " Trial# " + H.S(this.trialNum), 100, 50);
              J.fillText$3$x(this.ctx, "Score: " + H.S(this.score) + "  Time(Seconds): " + H.S(C.JSNumber_methods._tdivFast$1(P.Duration$(0, 0, 0, this.time.millisecondsSinceEpoch - this.time_started.millisecondsSinceEpoch, 0, 0)._duration, 1000000)), 100, 100);
              for (t1 = this.myState.myBoxes, t1 = new H.ListIterator(t1, t1.length, 0, null); t1.moveNext$0();)
                t1._current.draw$1(this.ctx);
              this.flagDraw = false;
            }
          else if (J.$eq(this.phaseBreak, "true")) {
            this.time_started = new P.DateTime(Date.now(), false);
            J.set$fillStyle$x(this.ctx, "black");
            J.set$font$x(this.ctx, "30px sans-serif");
            J.set$textAlign$x(this.ctx, "left");
            J.set$textBaseline$x(this.ctx, "center");
            J.fillText$3$x(this.ctx, "Take a 5 second break! The trial will start automatically.", 100, 50);
          }
        }
    },
    drawWelcome$0: function() {
      var t1, inputStage, t2, submitButton, inputID, submitIDButton;
      t1 = {};
      t1.inputStage_0 = null;
      t1.inputID_1 = null;
      t1.submitButton_2 = null;
      t1.submitIDButton_3 = null;
      if (J.$eq(this.phaseStarted, false) || J.$eq(this.phaseStarted, "false")) {
        ...
        J.set$textBaseline$x(this.ctx, "center");
        J.fillText$3$x(this.ctx, "Gaze Experiment: Client# " + H.S(this.clientID) + " Trial# " + H.S(this.trialNum), 100, 50);
        J.fillText$3$x(this.ctx, "Instructions: For this experiment you will be building a puzzle with a partner.", 100, 150);
        J.fillText$3$x(this.ctx, "Both you and your partner must simultaneously drag neighboring pieces next to each other to combine.", 100, 200);
        J.fillText$3$x(this.ctx, "Score: If you correctly combine pieces you will earn 10 points. If you incorrectly move pieces you will lose 10 points.", 100, 300);
        J.fillText$3$x(this.ctx, "Goal: Complete the puzzle quickly and earn points.", 100, 400);
        J.fillText$3$x(this.ctx, "For Experimenter:", 100, 525);
        ...
        C.CssStyleDeclaration_methods.set$top(t2, "650px");
        ...
        t1.submitButton_2 = submitButton;
        t2 = submitButton.style;
        J.getInterceptor$x(t2).set$position(t2, "absolute");
        C.CssStyleDeclaration_methods.set$left(t2, "100px");
        C.CssStyleDeclaration_methods.set$top(t2, "700px");
        C.CssStyleDeclaration_methods.set$font(t2, "30px sans-serif");
        t2 = t1.submitButton_2;
        t2.textContent = "Submit Trial Number";
        t2 = J.get$onClick$x(t2);
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._html$_target, t2._eventType, W._wrapZone(new X.Game_drawWelcome_closure(t1, this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
        document.body.appendChild(t1.submitButton_2);
        inputID = W.InputElement_InputElement(null);
        t1.inputID_1 = inputID;
        t2 = inputID.style;
        J.getInterceptor$x(t2).set$position(t2, "absolute");
        C.CssStyleDeclaration_methods.set$left(t2, "100px");
        C.CssStyleDeclaration_methods.set$top(t2, "550px");
        C.CssStyleDeclaration_methods.set$font(t2, "30px sans-serif");
        J.set$value$x(t1.inputID_1, "1");
        document.body.appendChild(t1.inputID_1);
        submitIDButton = document.createElement("button", null);
        t1.submitIDButton_3 = submitIDButton;
        t2 = submitIDButton.style;
        J.getInterceptor$x(t2).set$position(t2, "absolute");
        C.CssStyleDeclaration_methods.set$left(t2, "100px");
        C.CssStyleDeclaration_methods.set$top(t2, "600px");
        C.CssStyleDeclaration_methods.set$font(t2, "30px sans-serif");
        t2 = t1.submitIDButton_3;
        t2.textContent = "Submit ID Number";
        t2 = J.get$onClick$x(t2);
        H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t2._html$_target, t2._eventType, W._wrapZone(new X.Game_drawWelcome_closure0(t1, this)), t2._useCapture), [H.getTypeArgumentByIndex(t2, 0)])._tryResume$0();
        document.body.appendChild(t1.submitIDButton_3);
      }
  ...
  Game_drawWelcome_removeElements_closure: {
    ...
    call$0: function() {
      if (J.$eq(this.this_2.phaseStarted, "true")) {
        var t1 = this.box_0;
        J.remove$0$ax(t1.submitButton_2);
        J.remove$0$ax(t1.inputStage_0);
        J.remove$0$ax(t1.inputID_1);
        J.remove$0$ax(t1.submitIDButton_3);
      } else
        this.removeElements_3.call$0();
    }
  },
  Game_drawWelcome_closure: {
    "^": "Closure:7;box_0,this_4",
    call$1: function($event) {
      if (this.this_4.submittedID)
        $.ws.send("s:" + H.S(J.get$value$x(this.box_0.inputStage_0)));
      else
        window.alert("Enter ID Number First!");
    }
  },
  Game_drawWelcome_closure0: {
    "^": "Closure:7;box_0,this_5",
    call$1: function($event) {
      var t1, t2;
      t1 = this.box_0;
      $.ws.send("I:" + H.S(J.get$value$x(t1.inputID_1)));
      t2 = this.this_5;
      t2.clientID = J.toString$0(J.get$value$x(t1.inputID_1));
      t2.submittedID = true;
    }
  },
  ...
  initWebSocket_closure0: {
    "^": "Closure:7;retrySeconds_3,scheduleReconnect_4",
    call$1: function(e) {
  ...
  State: {
    ...
    updateBox$4: function(id, x, y, color) {
      ...
      if (!found) {
        temp = new X.Box(x, y, color, id, null, null, null, null, null, W.ImageElement_ImageElement(null, null, null), null, null, null, null, null, null, null, null, null);
        temp.Box$4(id, x, y, color);
  ...
  TouchManager_registerEvents_closure1: {
    ...
    call$1: function(e) {
      ...
      if (t1.mdown) {
        ...
        else if (t1.findTouchTarget$1(t) != null)
          ;
      }
      return;
    }
  ...
  Contact: {
    ...
    Contact$fromTouch$1: function(touch) {
      J.forEach$1$ax(J.get$touches$x(touch), new X.Contact$fromTouch_closure(this));
    },
  ...
  Contact$fromTouch_closure: {
    "^": "Closure:7;this_0",
    call$1: function(touch) {
      var t1, t2;
      J.get$identifier$x(touch);
      t1 = this.this_0;
      t2 = H.setRuntimeTypeInfo(new P.Point(C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(touch.pageX)), C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(touch.pageY))), [null]).x;
      t2.toString;
      t1.touchX = t2;
      t2 = H.setRuntimeTypeInfo(new P.Point(C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(touch.pageX)), C.JSNumber_methods.toInt$0(C.JSNumber_methods.roundToDouble$0(touch.pageY))), [null]).y;
      t2.toString;
      t1.touchY = t2;
      t1.finger = true;
    }
...
//# sourceMappingURL=remotepuzzletask.dart.js.map
